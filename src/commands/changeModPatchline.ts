...
async function pickPatchline(currentPatchline: SupportedPatchline): Promise<SupportedPatchline | undefined> {
...
function updateGradlePropertiesPatchline(workspaceRootPath: string, patchline: SupportedPatchline): void {
...
export function replacePatchlineInGradlePropertiesContent(content: string, patchline: SupportedPatchline): string {
